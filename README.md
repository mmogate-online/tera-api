...
4. Unpack the [shop-slides-bg.zip](share/data) archive to **data\shop-slides-bg** folder.
5. Unpack the [tera-icons.zip](share/data) archive to **data\tera-icons** folder.
