...
module.exports = async modules => express.Router()
	...
	.get("/ListCharacterCountsByUserNo", gatewayAccountController.ListCharacterCountsByUserNo(modules))
	...
	.get("/HasRecentLoginByIp", gatewayAccountController.HasRecentLoginByIp(modules))
	.post("/RegisterNewAccount", gatewayAccountController.RegisterNewAccount(modules))
	.post("/SetPasswordByUserNo", gatewayAccountController.SetPasswordByUserNo(modules))
	.post("/IssueAuthKey", gatewayAccountController.IssueAuthKey(modules))
